  ...
  return userData && (
    <div className="max-w-lg flex flex-col gap-2 text-sm">
      {
        ...
        <label htmlFor="image">
          <div className="inline-block relative cursor-pointer">
            <img className="w-36 rounded opacity-75 right-12" src={image ? URL.createObjectURL(image):userData.image} alt="" />
    ...
    <div>
      ...
      <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700">
        ...
        {
      isEdit ?
      <select className="max-w-20 bg-gray-100" name="" id="" value={userData.gender} onChange={e => setUserData(prev => ({...prev, gender: e.target.value}))}>
